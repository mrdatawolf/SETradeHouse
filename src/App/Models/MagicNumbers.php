...
class MagicNumbers extends Model
{
    ...
    protected $fillable = ['receipt_base_efficiency','base_multiplier_for_buy_vs_sell','base_refinery_kwh','base_refinery_speed','base_drill_per_kw_hour','markup_for_each_leg','markup_total_change','base_weight_for_system_stock','other_server_weight','distance_weight','server_id','cost_kw_hour','base_labor_per_hour'];
}