        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select id="server_id" name="server_id" class="form-control">
                        @foreach($serverIds as $id)
                            <option value="{{ $id }}" @if($id === $welcome->server_id) selected @endif>{{ $id }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:50px" name="message" id="message" placeholder="{{ $welcome->message }}"></textarea>
                </div>
            </div>
