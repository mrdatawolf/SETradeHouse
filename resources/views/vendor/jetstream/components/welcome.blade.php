...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ route('stores') }}">Your stores</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Get a look at your stores.
            </div>
        </div>

        <a href="{{ route('trends.ores.orders') }}">
            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                <div>Check the price of ores around @livewire('active-world')</div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Trade across @livewire('active-world') in @livewire('active-server')</div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Find the deals that will make you rich in @livewire('active-server')!
            </div>
        </div>

        <a href="{{ route('stores.world') }}">
            <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                <div>See what transactions are available in @livewire('active-world')</div>
