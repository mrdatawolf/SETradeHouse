<div>
    <div>
        ...
        <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="cargo-mass">
            Mass of Cargo (kg):
        </label>
        ...
        <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4" for="dry-weight">
